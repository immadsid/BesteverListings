  ...
  return (
    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-8 mt-8 sm:mt-[115px] mb-10 sm:mb-[132px] mx-4 sm:mx-0">
      ...
      <div className="text-center sm:text-left">
        <h1 className="w-full sm:w-[455px] text-[28px] sm:text-[55px] font-[500] leading-[44px] sm:leading-[74px] capitalize mb-4 sm:mb-0">
          Subscribe To Our Newsletter
        </h1>
        <p className="text-[16px] mt-[10px] leading-[30px] font-[400]">
          This Is A Great Spot For A newsletter Signup.
        </p>
        <form className="flex gap-[18px] mt-[30px]">
          <input
            className="sm:w-[437px] px-[20px] py-[10px] outline-none border border-[#3B338B] rounded-[6px]"
            type="email"
            placeholder="Enter Your Email*"
          />
          <button className="p-[15px] bg-[linear-gradient(103deg,_#3B338B_-73.19%,_#D460A3_177.21%)] rounded-[6px]">
            <img src="/images/Group 11.svg" alt="icon" />
          </button>
        </form>
      </div>
    </div>
